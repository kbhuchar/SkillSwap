  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-[#0d0d0d] px-4 py-12">
      ...
      <div className="fixed inset-0 pointer-events-none overflow-hidden">
        <div className="absolute -top-40 -right-40 w-96 h-96 rounded-full bg-cyan-900/20 blur-3xl" />
        <div className="absolute -bottom-40 -left-40 w-96 h-96 rounded-full bg-cyan-900/20 blur-3xl" />
      </div>
