    ...
    <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        <div>
          ...
          <input
            type="text"
            {...register("name")}
            className="w-full px-4 py-2.5 rounded-xl border border-[#444444] bg-[#2e2e2e] text-white text-sm placeholder:text-gray-500 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent"
          />
          {errors.name && (
      ...
      <div>
        ...
        <textarea
          ...
          {...register("bio")}
          className="w-full px-4 py-2.5 rounded-xl border border-[#444444] bg-[#2e2e2e] text-white text-sm placeholder:text-gray-500 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent resize-none"
        />
        {errors.bio && (
      ...
      <div>
        ...
        <div className="flex gap-2">
          <input
            ...
            className="flex-1 px-4 py-2 rounded-xl border border-[#444444] bg-[#2e2e2e] text-white text-sm placeholder:text-gray-500 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent"
          />
          <select
            ...
            className="px-3 py-2 rounded-xl border border-[#444444] bg-[#2e2e2e] text-white text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500"
          >
            {LEVELS.map((l) => (
      ...
      <div>
        ...
        <div className="flex flex-wrap gap-2 mb-3">
          {skillsWanted.map((s, i) => (
            <span
              key={i}
              className="inline-flex items-center gap-1.5 bg-indigo-900/20 text-indigo-400 text-sm px-3 py-1 rounded-full border border-indigo-800/30"
            >
              {s.name}
              {s.level && (
                <span className="text-xs opacity-70">
      ...
      <div className="flex items-center justify-end gap-3 pt-2">
        <button
          type="button"
          onClick={onCancel}
          className="px-5 py-2.5 rounded-xl border border-[#444444] text-sm font-medium text-gray-200 hover:bg-[#2e2e2e] transition-colors"
        >
          Cancel
        </button>
        <button
